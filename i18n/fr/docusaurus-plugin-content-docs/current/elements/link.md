...
L'element `<map-link>` est un element derive de l'element `link` d'HTML, pour
aider a creer les cartes Web.  Most of the extensions center on proposed new values of the `rel` attribute.
